...
; Legendas dos Campos
	...
	; Nome, diciplina e período
		...
		loop_p1:
		    ...
		    mov     al,[bx+nome]
			call	caracter
			cmp	dl, 65		; Compara dl com (cx+dl+1), se dl forem iguais -> zf = 1
			je		print_abrir
	...
	; Abrir
		...
		loop_p2:
		    ...
		    mov     al,[bx+abrir]
			call	caracter
			cmp	dl, 9		; Compara dl com (cx+dl+1), se dl forem iguais -> zf = 1
			je		print_sair
		    inc     bx			;proximo caracter
			inc		dl			;avanca a coluna
		    loop    loop_p2
	...
	; Sair
		...
		loop_p3:
		    ...
		    mov     al,[bx+sair]
			call	caracter
			cmp	dl, 18		; Compara dl com (cx+dl+1), se dl forem iguais -> zf = 1
			je		print_pbaixas
		    inc     bx			;proximo caracter
			inc		dl			;avanca a coluna
		    loop    loop_p3
	...
	; Passa-Baixas
		...
		loop_p4:
		    ...
		    mov     al,[bx+pbaixas]
			call	caracter
			cmp	dl, 37		; Compara dl com (cx+dl+1), se dl forem iguais -> zf = 1
			;je		print_pbaixas
		    inc     bx			;proximo caracter
			inc		dl			;avanca a coluna
		    loop    loop_p4
	...
	; Passa-Altas
		...
		loop_p5:
		    ...
		    mov     al,[bx+paltas]
			call	caracter
			cmp	dl, 56		; Compara dl com (cx+dl+1), se dl forem iguais -> zf = 1
			je		print_gradiente
		    inc     bx			;proximo caracter
			inc		dl			;avanca a coluna
		    loop    loop_p5
	...
	; Gradiente
		...
		loop_p6:
		    ...
		    mov     al,[bx+gradiente]
			call	caracter
			cmp	dl, 88		; Compara dl com (cx+dl+1), se dl forem iguais -> zf = 1
			;je		print_pbaixas
		    inc     bx			;proximo caracter
			inc		dl			;avanca a coluna
		    loop    loop_p6
